...
import { Button, Grid, Typography, Stack, Card, LinearProgress, CardContent, CardActions, Box } from '@mui/material';
...
const Home: NextPage = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <Sidebar refreshData={refreshData} setRefreshData={setRefreshData} />
      {/* <TableDisplay /> */}
      <main>
